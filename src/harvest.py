...
print("snapshot dates: ",first_snapshot_date, second_snapshot_date)
print("count of identifiers_in_first_json_missing_from_second_json_and_not_same_title_or_close",missing_data_object['identifiers_in_first_json_missing_from_second_json_and_not_same_title_or_close']['count'])
